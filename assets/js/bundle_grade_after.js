...
(() => {
  ...
  function pageType(){
    ...
    if(title.includes('диагност')) return state.page = 'diagnostic';
  ...
  function injectStyle(){
    ...
    style.textContent = `
      ...
      body.wave24-mobile-shell{padding-bottom:calc(84px + env(safe-area-inset-bottom,0)) !important;}
      ...
      .wave24-install-btn{position:fixed;right:12px;bottom:calc(88px + env(safe-area-inset-bottom,0));z-index:9998;display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border:none;border-radius:999px;background:var(--text,#1a1a2e);color:#fff;font:700 12px/1.2 'Golos Text',system-ui,sans-serif;box-shadow:0 12px 28px rgba(0,0,0,.22);cursor:pointer;-webkit-appearance:none;touch-action:manipulation}
      .wave24-install-btn:active{transform:scale(.98)}
      .wave24-install-btn[hidden]{display:none!important}
      .wave24-bottom-nav{position:fixed;left:0;right:0;bottom:0;z-index:9997;display:flex;gap:8px;align-items:stretch;padding:8px 12px calc(8px + env(safe-area-inset-bottom,0));background:rgba(245,243,238,.92);backdrop-filter:blur(14px);border-top:1px solid var(--border,#e2e0d8);box-shadow:0 -8px 28px rgba(0,0,0,.08)}
      .wave24-bottom-nav a,.wave24-bottom-nav button{flex:1;min-width:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;padding:8px 6px;border:none;border-radius:14px;background:transparent;color:var(--muted,#6b6a74);font:700 11px/1.1 'Golos Text',system-ui,sans-serif;text-decoration:none;cursor:pointer;-webkit-appearance:none;touch-action:manipulation}
      ...
      .wave24-has-bottom-nav header{padding-right:max(16px, env(safe-area-inset-right,0));padding-left:max(16px, env(safe-area-inset-left,0));}
      ...
      @media (min-width: 768px){
        body.wave24-mobile-shell{padding-bottom:calc(92px + env(safe-area-inset-bottom,0)) !important;}
