(function(){
  ...
  function boot(){fetchJson(MANIFEST).then(function(m){store.manifest=m;setStatus('Манифест: '+m.total_questions+' вопросов');build()}).catch(function(e){setStatus(e.message)});$('teacherBuild').onclick=build;$('teacherExport').onclick=exportJson}
