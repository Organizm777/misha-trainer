...
- `audit_special_subjects_wave91b.mjs` — verifies the wave91b special-subject expansion: fashion design, architecture, and graphic design JSON banks, runtime metadata, styles, index counters, and service-worker precache entries.
