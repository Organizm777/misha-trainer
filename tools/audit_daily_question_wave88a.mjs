...
assert(/^(wave88[abcd]|wave89a)$/.test(healthz.wave), `healthz.json: expected wave88a/wave88b/wave88c/wave88d/wave89a, got ${healthz.wave}`);
assert(/^(wave88[abcd]|wave89a)$/.test(healthz.build_id), `healthz.json: expected build_id wave88a/wave88b/wave88c/wave88d/wave89a, got ${healthz.build_id}`);
