...
assert(/^(wave88[abcd]|wave89[abcd])$/.test(healthz.wave), `healthz.json: expected wave88a/wave88b/wave88c/wave88d/wave89a/wave89b/wave89c/wave89d, got ${healthz.wave}`);
assert(/^(wave88[abcd]|wave89[abcd])$/.test(healthz.build_id), `healthz.json: expected build_id wave88a/wave88b/wave88c/wave88d/wave89a/wave89b/wave89c/wave89d, got ${healthz.build_id}`);
