...
assert(/^(wave87[yz]|wave88[abc])$/.test(healthz.wave), `healthz.json: expected wave87y/wave87z/wave88a/wave88b/wave88c, got ${healthz.wave}`);
assert(/^(wave87[yz]|wave88[abc])$/.test(healthz.build_id), `healthz.json: expected build_id wave87y/wave87z/wave88a/wave88b/wave88c, got ${healthz.build_id}`);
