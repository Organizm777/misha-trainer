...
assert(/^(wave87[yz]|wave88[abcd])$/.test(healthz.wave), `healthz.json: expected wave87y/wave87z/wave88a/wave88b/wave88c/wave88d, got ${healthz.wave}`);
assert(/^(wave87[yz]|wave88[abcd])$/.test(healthz.build_id), `healthz.json: expected build_id wave87y/wave87z/wave88a/wave88b/wave88c/wave88d, got ${healthz.build_id}`);
