...
assert(/^(wave87z|wave88[abcd])$/.test(healthz.wave), `healthz.json: expected wave87z/wave88a/wave88b/wave88c/wave88d, got ${healthz.wave}`);
assert(/^(wave87z|wave88[abcd])$/.test(healthz.build_id), `healthz.json: expected build_id wave87z/wave88a/wave88b/wave88c/wave88d, got ${healthz.build_id}`);
